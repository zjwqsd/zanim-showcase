...
import { compositingScene, rubiksCubeScene, threeDShowcaseScene } from './advanced.js'
import {
  Arrow,
  BLUE,
  BOTTOM,
...
export const scenes = [
  ...
  { id:'electric-field', title:'Moving electric field', source:'extras/electric_field.py', width:1280, height:720, builder:electricFieldScene },
  { id:'neural-network', title:'Batched neural network', source:'extras/neural_network.py', width:1280, height:720, builder:neuralNetworkScene },
  { id:'sorting', title:'Sorting algorithms', source:'extras/sorting_algorithms.py', width:1280, height:960, builder:sortingScene, note:'The browser uses the exact trace generated by the Python example.' },
  { id:'red-black-tree', title:'Red-black tree', source:'extras/red_black_tree.py', width:1280, height:960, builder:redBlackTreeScene, note:'Insert/recolor/rotation states come from the Python CLRS implementation.' },
  { id:'collisions', title:'Elastic collisions', source:'extras/simulation_collisions.py', width:1280, height:720, builder:collisionScene, note:'The 240 Hz Python simulation is sampled into deterministic browser data.' },
  { id:'rubiks-cube', title:"Rubik's Cube", source:'extras/rubiks_cube.py', width:1280, height:720, builder:rubiksCubeScene },
  { id:'compositing', title:'Scene compositing', source:'showcase/compositing.py', width:1280, height:720, builder:compositingScene },
