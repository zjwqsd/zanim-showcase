"""Lesson 01: declare/layout → add → animate, with no required setup boilerplate."""
...
class Basics(Scene):
    def construct(self) -> None:
        ...
        title = Text("Objects define; Scene owns time", font_size=34, opacity=0)
        subtitle = Math(
        ...
        stage, title, subtitle = self.add(stage, title, subtitle)
        number_line, shapes, arrow = stage.children
